        <div class="content__addpage">
            <nav class="addpage__nav">
                <ul class="nav__ul">
                    ...
                    <a class="nav__link" href="/profile"><li class="nav__li nav__li___user"><?=Models\User::getOneById( \Controllers\Add::$user )[0]['username'] ?></li></a>
                </ul>
            </nav>
        </div>
        <header class="content__header">
            <h1 contenteditable="" id="title" class="article__title">Название страницы</h1>
            <br>
            <h3 class="article__url___link">http://<?=$_SERVER['HTTP_HOST']?><span id="url" contenteditable="">nazvanie-stranitsy</span><h3>
