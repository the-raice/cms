...
<?php endforeach; ?>
			...
			<script type="text/javascript">
				$('.nav__link__settings').hover(function () {
					
					setTimeout(function(){ $('path').css("fill", "#00d3d3"); }, 0);
